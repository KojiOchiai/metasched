...
class Liquid(Node):
    ...
    def _add(self, other: "Liquid") -> "Liquid":
...
class Well(Node):
    ...
    def _add(self, other: Liquid) -> "Well":
...
class Jig(Node):
    ...
    def _add(self, other: "Object") -> "Jig":
...
class Object(Node):
    ...
    def _add(self, other: Union[Jig, Well]) -> "Object":
...
class Root(Node):
    ...
    def _add(self, other: Object) -> "Root":
        if not isinstance(other, Object):
...
if __name__ == "__main__":
    root = Root(name="Root").add(
        Object(name="TubeRack", shape="tube_rack").add(
